...
function f(t,e,o){t.addEventListener("click",t=>{t.target.classList.add("disabled");let a=t.target.dataset.id,n=e.findIndex(t=>t.id===a);-1!==n?e[n].count++:e.push({id:a,count:1}),y(e,o),b()})}// ===============================
...
to.innerText=t.volumeInfo.authors,"NOT_FOR_SALE"!==t.saleInfo.saleability?(tn.innerHTML='<i class="fa-solid fa-circle-check text-success"></i> Available',tn.classList.add("text-success")):(tn.innerHTML='<i class="fa-solid fa-circle-xmark text-danger "></i> Not Available',tn.classList.add("text-danger"))),tl&&(tl.innerHTML=`<button
...
// console.log(item.id);
d(t),m(t)});// ddd();
}(null==(t=RegExp("[?&]productId=([^&#]*)").exec(window.location.href))?null:t[1]||0);const Z=document.getElementById("book-name"),Q=document.querySelector(".book__img"),X=document.querySelector(".book__name"),tt=document.querySelector(".book__isbn"),te=document.querySelector(".book__isbn13"),to=document.querySelector(".book__author"),ta=document.querySelector(".book__price"),tn=document.querySelector(".book__availability"),ts=document.querySelector(".book__description-text"),ti=document.querySelector(".information__details"),tl=document.querySelector(".book__buttons");// =========================
// ADDING BESTSELLERS CARDS=====================================================
let tc=Math.floor(34*Math.random());const tr=document.getElementById("related-cards");o(S(tc,tc+5),tr);// ========================================
//# sourceMappingURL=index.3b25f7b7.js.map
