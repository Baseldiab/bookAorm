...
//     let foundItem = arrayName.find((item) => item.id === dataId);
//     if (foundItem) {
//       foundItem.count += 1;
//     } else {
...
//     let cartArray = [];
//     items.forEach(item => {
//       const product = data.items.find(book => book.id === item.id);
//       if (product) {
...
//               min="0" data-price=".${dataPrice}"  data-singlePrice="${dataPrice}"
...
// $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
let count = 0;
const staticsElements = document.querySelectorAll(".count");
const updateStatics = ()=>{
    staticsElements.forEach((el)=>{
        let end = parseInt(el.getAttribute("data-count"));
        if (count < end) {
            count++;
            el.innerText = count;
            setTimeout(updateStatics, 10);
...
let books = getPromiseData("https://www.googleapis.com/books/v1/volumes?q=programming&key=AIzaSyDXEzxMOB3K7xzwZH9NeqK0-bDCfm7pV5Y");
let featuredBooksHtml = document.querySelector(".featured-books");
promiseToCard(books, featuredBooksHtml);
// ===========================
// POPULAR BOOKS SECTION ==============================
let popularBooks = getPromiseData("https://www.googleapis.com/books/v1/volumes?q=programming&key=AIzaSyDXEzxMOB3K7xzwZH9NeqK0-bDCfm7pV5Y");
let popularBooksHtml = document.querySelector(".popular-books");
promiseToCard(popularBooks, popularBooksHtml);
// ===========================
// WISHLIST PAGE ###########################
// ===========================
// DISPLAYING BOOKS IN WISHLIST =======================
let wishListBooks = getPromiseData("https://www.googleapis.com/books/v1/volumes?q=programming&key=AIzaSyDXEzxMOB3K7xzwZH9NeqK0-bDCfm7pV5Y");
let wishListHtml = document.querySelector(".wishlist");
filterDataStorage(wishListBooks, idWishArray);
promiseToCard(wishListBooks, wishListHtml);
// ===========================
// CART PAGE ###########################
// ===========================
// DISPLAYING BOOKS IN CART =======================
let cartBooks = getPromiseData("https://www.googleapis.com/books/v1/volumes?q=programming&key=AIzaSyDXEzxMOB3K7xzwZH9NeqK0-bDCfm7pV5Y");
let cartBooksHtml = document.querySelector(".cart");
filterDataStorage(cartBooks, idCartArray);
promiseToCard(cartBooks, cartBooksHtml); // ===========================
