...
let a=[...new Set(o)];// console.log(bookWishArray);
$(a).each((t,e)=>{price="NOT_FOR_SALE"==e.saleInfo.saleability?"Not Available":`EGP${e.saleInfo.listPrice?.amount.toFixed(2)}`,// =========================================================
// let singlePrice = book[0].id;
...
// getPromiseData(0, 20);
function(t){e(`https://www.googleapis.com/books/v1/volumes/${t}`).then(t=>{let e=`EGP${t?.saleInfo?.listPrice?.amount.toFixed(2)}`;t.saleInfo?.saleability=="NOT_FOR_SALE"&&(e="NOT AVAILABLE"),(Z||Q||tt||X||te||to||ta||tn)&&(Z.innerText=t.volumeInfo.title,// ===================
...
//# sourceMappingURL=index.692f180f.js.map
