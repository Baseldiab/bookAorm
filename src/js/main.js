...
let books = getPromiseData(
  "https://www.googleapis.com/books/v1/volumes?q=programming&key=AIzaSyDXEzxMOB3K7xzwZH9NeqK0-bDCfm7pV5Y"
);
let featuredBooksHtml = document.querySelector(".featured-books");
promiseToCard(books, featuredBooksHtml);
// ===========================
// POPULAR BOOKS SECTION ==============================
let popularBooks = getPromiseData(
  "https://www.googleapis.com/books/v1/volumes?q=programming&key=AIzaSyDXEzxMOB3K7xzwZH9NeqK0-bDCfm7pV5Y"
);
...
let wishListBooks = getPromiseData(
  "https://www.googleapis.com/books/v1/volumes?q=programming&key=AIzaSyDXEzxMOB3K7xzwZH9NeqK0-bDCfm7pV5Y"
);
